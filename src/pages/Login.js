...
export default function Login() {
  ...
  return (
    <div className="bg-purple-200 h-screen">
      <div className="rounded-xl shadow-md flex items-center justify-center flex-col bg-black h-72 w-80 absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 xs:w-[22rem]">
        <svg
        ...
        <button
          onClick={logInUser}
          className="uppercase bg-purple-500/90 shadow-sm tracking-wider shadow-sky-800 text-white p-2 px-8 rounded font-semibold hover:bg-purple-500"
        >
          sign in with google
        </button>
      </div>
