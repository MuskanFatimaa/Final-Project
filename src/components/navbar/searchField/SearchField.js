  ...
  return (
    <div className="w-full flex md:ml-0 items-center ">
      ...
      <div className="relative w-full text-gray-400 focus-within:text-gray-600">
        ...
        <input
          id="search-field"
          className="block w-full h-full pl-8 pr-3 py-2 border-transparent text-gray-900 placeholder-gray-600 focus:outline-none focus:placeholder-gray-400 focus:ring-0 focus:border-transparent sm:text-sm"
          placeholder="Search"
          type="text"
          value={query}
